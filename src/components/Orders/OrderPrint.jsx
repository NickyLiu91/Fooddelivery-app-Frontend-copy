...
import { printStyles } from './Orders.styled';
          ...
          <Grid container direction="row" justify="space-between" alignItems="center">
            ...
            <Grid item>
              <Typography className={classes.title}>
                {`${order.type === 'delivery' ? 'Delivery' : 'Pick up'} by ${order &&
                  moment(order.scheduled_date).tz(timezone).format('ddd, MMM D, hh:mm a')}`}
              </Typography>
            </Grid>
          </Grid>
        </div>
        <div className={classes.printContentWrapper}>
          <Grid container direction="column">
            ...
            <div>
              <Grid container direction="row" alignItems="center">
                {` ${moment(order.created_at)
                    .tz(timezone).format('ddd, MMM D, hh:mm a')}`}
              </Grid>
            </div>
          </Grid>
          <Divider />
...
export default withStyles(printStyles)(OrdersDialog);
